...
import com.highgo.jdbc.jdbc.PgConnection;
...
import io.trino.plugin.highgo.HighgoConfig.ArrayMapping;
import static io.trino.plugin.highgo.HighgoConfig.ArrayMapping.AS_ARRAY;
import static io.trino.plugin.highgo.HighgoConfig.ArrayMapping.AS_JSON;
import static io.trino.plugin.highgo.HighgoConfig.ArrayMapping.DISABLED;
import static io.trino.plugin.highgo.HighgoSessionProperties.getArrayMapping;
import static io.trino.plugin.highgo.HighgoSessionProperties.isEnableStringPushdownWithCollate;
import static io.trino.plugin.highgo.TypeUtils.arrayDepth;
import static io.trino.plugin.highgo.TypeUtils.getArrayElementPgTypeName;
import static io.trino.plugin.highgo.TypeUtils.getJdbcObjectArray;
import static io.trino.plugin.highgo.TypeUtils.toPgTimestamp;
...
public class HighgoClient
        extends BaseJdbcClient
{
    private static final Logger log = Logger.get(HighgoClient.class);
            ...
            IdentifierMapping identifierMapping)
    {
        ...
        this.aggregateFunctionRewriter = new AggregateFunctionRewriter<>(
                ...
                ImmutableSet.<AggregateFunctionRule<JdbcExpression, String>>builder()
                        ...
                        .add(new ImplementSum(HighgoClient::toTypeHandle))
        ...
        switch (typeHandle.getJdbcType()) {
            ...
            case Types.TIMESTAMP:
                ...
                return Optional.of(ColumnMapping.longMapping(
                        ...
                        HighgoClient::shortTimestampWriteFunction));
    ...
    public WriteMapping toWriteMapping(ConnectorSession session, Type type)
    {
        ...
        if (type instanceof TimestampType) {
            ...
            if (timestampType.getPrecision() <= POSTGRESQL_MAX_SUPPORTED_TIMESTAMP_PRECISION) {
                ...
                return WriteMapping.longMapping(format("timestamp(%s)", timestampType.getPrecision()), HighgoClient::shortTimestampWriteFunction);
            }
            verify(timestampType.getPrecision() > TimestampType.MAX_SHORT_PRECISION);
